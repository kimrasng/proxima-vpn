    ...
    "paths": {
        ...
        "/admin/auth/2fa/enable": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Secret and TOTP code",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/admin/node-groups/{id}/nodes": {
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Node IDs to assign",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/admin/users/{id}/login-history": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "Maximum attempts to return (default 50, max 200)",
                        "name": "limit",
                        "in": "query"
                    }
                ],
        ...
        "/sub/{sub_token}/{device_id}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Base64-encoded proxy configuration",
                        "schema": {
                            "type": "string"
                        }
                    },
    ...
    "definitions": {
        ...
        "internal_handlers.nodeListItem": {
            ...
            "properties": {
                ...
                "status_changed_at": {
                    "description": "When status last flipped; null for nodes that predate the column.",
                    "type": "string"
                },
                "traffic_multiplier": {
